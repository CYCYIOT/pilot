...
#define UBX_TX_CFG_RATE_MEASINTERVAL	100		/**< 200ms for 5Hz */
...
typedef struct gps_info_s {
	double lat;					/**< Latitude in 1E-7 degrees */
	double lon;					/**< Longitude in 1E-7 degrees */
	double alt;					/**< Altitude in 1E-3 meters (millimeters) above MSL  */
...
typedef struct {
	...
	ubx_buf_t		   _buf;
	ubx_ack_state_t    _ack_status;
	gps_info_s         _gps_info;
	int                _uart_fd;
}ubx_decoder_t;
