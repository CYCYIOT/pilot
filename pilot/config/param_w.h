...
#define INAV__FLOW__FUSE_VEL_NORMAL_DEF		    6.00f   //2.50f     
...
#define CON__COMM__ATT_RP_LIMIT_DEF				10.0f//20.00f
...
#define CON__POSHOLD__AIR_RES_COFF_DEF	 		1.0f//0.3f

#define ATT__RATE_RP_LOW_FILTER_DEF				50.0f
#define ATT__RATE_YAW_LOW_FILTER_DEF			30.0f        

#define PID__ATT__ROLL_P_DEF 					0.15f 
#define PID__ATT__PITCH_P_DEF					0.15f  
...
#define PID__RATE__YAW_P_DEF					0.40f   //0.40f
...
#define PID__VEL__Z_P_DEF         			0.30f        
