#ifndef _PARAM_EVAB_H_
#define _PARAM_EVAB_H_

#define IMU__ROTATION_DEF	6.0f
#define MAG__ROTATION_DEF	0.0f
#define FLOW__ROTATION_DEF	26.0f
...
#define AHRS__RP_I_ARM_DEF					0.002f
...
#define FLOW__DELAY_DEF						0.03f		//0328-0.02  7740-0.03
#define FLOW__SCALE_DEF						0.0018f		//0328-0.0016  7740-0.0015
...
#define INAV__FLOW__FUSE_VEL_FLIP2_DEF		4.50f
#define INAV__FLOW__FUSE_BIAS_FLIP2_DEF		11.00f
#define INAV__FLOW__FUSE_POS_FLIP_STEP_DEF	0.50f
#define INAV__FLOW__FUSE_VEL_FLIP_STEP_DEF	0.50f
#define INAV__FLOW__FUSE_BIAS_FLIP_STEP_DEF	0.50f
...
#define INAV__FLOW__FUSE_BIAS_NORMAL_DEF	2.00f
#define INAV__FLOW__FUSE_POS_ROTATE_DEF		1.00f
#define INAV__FLOW__FUSE_VEL_ROTATE_DEF		1.50f
...
#define INAV__FLOW__FUSE_BIAS_ACTION_DEF	0.10f
...
#define INAV__BARO__FUSE_POS_ACTION_DEF			1.00f
#define INAV__BARO__FUSE_VEL_ACTION_DEF			0.80f
#define INAV__BARO__FUSE_BIAS_ACTION_DEF		0.20f  //new_bias = pos^2 * old_bias / 0.05
...
#define INAV__BARO__FUSE_POS_NORMAL_DEF			0.45f
#define INAV__BARO__FUSE_VEL_NORMAL_DEF			0.55f
#define INAV__BARO__FUSE_BIAS_NORMAL_DEF		0.30f
...
#define INAV__BARO__FUSE_BIAS_STEP_DEF			1.20f
...
#define CON__COMM__ATT_RP_LIMIT_DEF			15.00f
#define CON__COMM__RATE_RP_LIMIT_DEF		5.00f
...
#define CON__COMM__ATT_RP_GAIN_DEF			12.0f
...
#define PID__ATT__ROLL_P_DEF 				0.20f
#define PID__ATT__PITCH_P_DEF				0.20f
#define PID__ATT__YAW_P_DEF 				0.04f

#define PID__RATE__ROLL_P_DEF				0.13f
#define PID__RATE__ROLL_I_DEF				0.2f
#define PID__RATE__ROLL_D_DEF				0.004f
#define PID__RATE__ROLL_D_W_DEF 			0.7f
#define PID__RATE__ROLL_I_MAX_DEF			0.2f
#define PID__RATE__ROLL_I_INIT_DEF			0.0f

#define PID__RATE__PITCH_P_DEF				0.13f
#define PID__RATE__PITCH_I_DEF				0.2f
#define PID__RATE__PITCH_D_DEF				0.004f
...
#define PID__RATE__YAW_I_INIT_DEF			0.00f
...
#define PID__VEL__Z_P_DEF					0.5f
#define PID__VEL__Z_I_DEF         			0.5f
#define PID__VEL__Z_D_DEF         			0.05f
...
#define MOTOR__RP_MAX_DEF			0.90f
...
#define LOG__RATE_PIDRR_DEF			0.0f
#define LOG__RATE_PIDRP_DEF			0.0f
#define LOG__RATE_PIDRY_DEF			0.0f
#define LOG__RATE_PIDVX_DEF			0.0f
#define LOG__RATE_PIDVY_DEF			0.0f
#define LOG__RATE_PIDVZ_DEF			0.0f
